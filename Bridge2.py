# The Bridge pattern is a process about separating abstraction and implementation.
...
class OSAbstract(metaclass=ABCMeta):
 ...
 # Running client, following output will be displayed:

 #Now implement on Windows
 #a
 #b
 #c
 #Now implement on Mac
 #('a', 'b', 'c')